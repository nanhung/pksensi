...
```{r, fig.cap = 'Figure 2. The range of model simulation based on parameter distribution'}
...
```{r, 'Figure 3: Heatmap of sensitivity index for interaction'}
heat_check(x, order = "interaction")
```

```{r, 'Figure 4: Heatmap of convergence index for total order'}
...
```{r, 'Figure 5: Heatmap of convergence index'}
