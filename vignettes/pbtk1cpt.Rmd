...
Using the `ode()` function in **deSolve** package. Unlike above example, we have to asign additional arguments, such as `dllname`, `initfunc`, `nout`, and `outnames`.
