...
#'
#' @description
#' The \code{solve_MCSim} solves for the time-dependent quantity/concentration in different tissues
...
#' @param parameters a vector to assign the testing parameter.
#' @param output a character or a vector to assign the selected output.
...
#' @rdname solve_MCSim
#' @export
gen_infile <- function(infile.name, outfile.name, parameters, output, time,
